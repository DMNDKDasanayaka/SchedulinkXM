...
<div class="container mt-4">
    <h2>Edit Exam Hall</h2>
    
    <div class="card">
        <div class="card-body">
            <form action="/halls/update/<?= $hall['id'] ?>" method="POST">
                <div class="mb-3">
                    <label for="name" class="form-label">Hall Name</label>
                    <input type="text" class="form-control <?= isset($errors['name']) ? 'is-invalid' : '' ?>" 
                           id="name" name="name" value="<?= htmlspecialchars($hall['name']) ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control <?= isset($errors['capacity']) ? 'is-invalid' : '' ?>" 
                           id="capacity" name="capacity" min="1" value="<?= htmlspecialchars($hall['capacity']) ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="faculty" name="faculty" 
                           value="<?= htmlspecialchars($hall['faculty'] ?? '') ?>">
                </div>
